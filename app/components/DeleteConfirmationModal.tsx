      ...
      >
        ...
        <div className="flex gap-4 items-start pr-8">
          ...
          <div className="flex flex-col gap-1.5">
            <h3 className="text-xl font-bold text-gray-950 leading-tight">Delete account</h3>
            <p className="text-gray-500 text-sm leading-relaxed">
              Are you sure you want to delete <span className="font-semibold text-gray-800">&quot;{accountName}&quot;</span>? This will permanently remove it from your session and update totals.
            </p>
          </div>
        </div>
