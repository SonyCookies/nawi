...
interface AddScheduledIncomeModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSaved?: () => void;
...
export default function AddScheduledIncomeModal({ isOpen, onClose, onSaved, itemToEdit }: AddScheduledIncomeModalProps) {
    ...
    try {
      ...
      if (itemToEdit && itemToEdit.id) {
        ...
        window.dispatchEvent(new CustomEvent("show_toast", {
          detail: { title: "Scheduled Income Saved", description: `${description.trim()} updated.`, type: "success" }
        }));
      } else {
        ...
        window.dispatchEvent(new CustomEvent("show_toast", {
          detail: { title: "Scheduled Income Added", description: `${description.trim()} saved.`, type: "success" }
        }));
      }
      onSaved?.();
      onClose();
        ...
        <div className="flex justify-between items-start">
          <div className="flex flex-col gap-1.5">
            <h2 className="text-2xl font-bold text-gray-900 leading-none">
              {itemToEdit ? "Edit Scheduled Income" : "Add Scheduled Income"}
            </h2>
            <p className="text-sm text-gray-400">
              {itemToEdit ? "Modify recurring income details." : "Track expected recurring salary or incoming funds."}
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              placeholder="Salary, Freelance payout, Rental income..."
