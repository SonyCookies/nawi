      ...
      >
        ...
        <div className="flex gap-4 items-start pr-8">
          ...
          <div className="flex flex-col gap-1.5">
            <h3 className="text-xl font-bold text-gray-950 leading-tight">Delete budget</h3>
            <p className="text-gray-500 text-sm leading-relaxed">
              Are you sure you want to delete the budget limit for <span className="font-semibold text-gray-800">&quot;{categoryName}&quot;</span>? This will stop tracking limits for this category, but past transaction history will remain intact.
            </p>
          </div>
        </div>
