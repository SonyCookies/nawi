...
export default function CollectibleDetailModal({
  debt,
  isOpen,
  onClose,
  onIncreaseClick,
  ...
  const getLogTypeLabel = (type: DebtLog["type"]) => {
    switch (type) {
      ...
      case "payment": return "Collected";
      case "increase": return "Added Owed";
    }
  };
      ...
      >
        ...
        <div className="flex justify-between items-start shrink-0">
          <div className="flex flex-col gap-1.5">
            ...
            <p className="text-sm text-gray-400">Collectible details and history timeline.</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="flex flex-col gap-1.5 bg-gray-50/50 border border-gray-100/80 rounded-xl p-3 shadow-sm shrink-0">
          <div className="flex justify-between text-xs font-semibold text-gray-500">
            ...
            <span className="text-purple-700">{progressPct}% ({formatCurrency(debt.paidAmount)} collected)</span>
          </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex flex-col gap-0.5">
                    <div className="text-sm font-semibold text-gray-800">
                      {log.note || (log.type === "payment" ? "Collection received" : "Adjusted amount")}
                    </div>
                    {log.accountName && (
                      <div className="text-[11px] text-gray-400 font-medium">
                        Deposited to {log.accountName} {log.category ? `• Category: ${log.category}` : ""}
                      </div>
                    )}
...
<body>
  <div class="receipt">
    <div class="header">
      ...
      <p class="subtitle">Official Collectible Statement</p>
    </div>
    ...
    <div class="meta-row">
      <span class="meta-label">Debtor Name:</span>
    ...
    <div class="footer">
      Thank you for utilizing Nawi Budgets.<br>Keep tracking, keep saving.
              ...
              a.href = url;
              a.download = `receipt-${debt.personName.toLowerCase().replace(/\s+/g, "-")}.html`;
